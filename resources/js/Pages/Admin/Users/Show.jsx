                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="mt-4 w-full">
                                            <div className="flex items-center justify-between py-2 border-b border-slate-700">
                                                ...
                                                <span className="text-white">{user.news_count || 0}</span>
                                            </div>
                                ...
                                <div className="md:col-span-2">
                                    <div className="mb-6">
                                        ...
                                        <div className="bg-slate-800 p-4 rounded-lg">
                                            {user.faculty_profile?.bio ? (
                                                <p className="text-slate-300 whitespace-pre-line">{user.faculty_profile.bio}</p>
                                            ) : (
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="bg-slate-800 p-4 rounded-lg">
                                            {user.faculty_profile?.specialization ? (
                                                <div className="flex flex-wrap gap-2">
                                                    {user.faculty_profile.specialization.split(',').map((item, index) => (
                                                        <span 
                                                            key={index}
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-slate-800 p-4 rounded-lg">
                                            <div className="space-y-2">
                                                ...
                                                {user.faculty_profile?.phone && (
                                                    <div className="flex items-center">
                                                        <svg className="h-5 w-5 text-slate-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                                        </svg>
                                                        <span className="text-slate-300">{user.faculty_profile.phone}</span>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                                ...
                                <div className="mt-8">
                                    ...
                                    <div className="bg-slate-800 rounded-lg p-4">
                                        <div className="space-y-4">
                                            {user.news.slice(0, 5).map((article) => (
                                        ...
                                        {user.news_count > 5 && (
                                            <div className="mt-4 text-center">
                                                <Link 
                                                    href={route('admin.news.index', { user: user.id })}
                                                    className="text-blue-400 hover:text-blue-300 text-sm font-medium"
                                                >
                                                    View all articles by {user.name.split(' ')[0]} →
                                                </Link>
                                            </div>
                                        )}
                                    </div>
